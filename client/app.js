async function getMovies() {
    await fetch('https://moviecrudlitejose.azurewebsites.net/readjson', {
        method: "GET"
    })
    ...
    if (updateBtn) {
        updateBtn.addEventListener('click', () => {
            ...
            fetch(`https://moviecrudlitejose.azurewebsites.net/update/${selectedMovieId}`, {
            method: 'PUT',
            headers: {
...
if (deleteBtn) {
    ...
    // Send a PUT request to your Express.js server
    fetch(`https://moviecrudlitejose.azurewebsites.net/delete/${selectedMovieId}`, {
      method: 'DELETE',
    })
      .then((response) => response.json())
      .then((data) => {
